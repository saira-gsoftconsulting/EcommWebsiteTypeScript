...
import img from '../../assests/images/cartImage.png';
...
const CartList: React.FC = () => {
  ...
  const cartItems: CartItem[] = useSelector((state: RootState) => state.product.cart);
  const [address, setAddress] = useState<string>("Main Street, Hayyat Abad");
    ...
    <div className="flex flex-col md:flex-col md:text-center lg:flex-row px-4 md:px-8 lg:px-12 gap-4">
      <div className="p-4 w-full">
        {cartItems.length === 0 ? (
          ...
          <img className="text-5xl" src={img} alt="cart image"/>
